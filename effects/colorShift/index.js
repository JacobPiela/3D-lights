...
const noise2D = noise.makeNoise2D(Date.now())
...
exports.draw = function(pixels,args,daltaTime){
    let color = HSVtoColor((noise2D(index, 1)+1)*128,mapRange(noise2D(index2, 100),-1,1,30,255),args["Brightness"])
    index  += 0.005*daltaTime
    index2 += 0.001*daltaTime
